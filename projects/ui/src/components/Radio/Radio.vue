<template>
    <label :class="['radio-container','radio-size-'+currentSize]"  @click = "getfocus">
        <input :value="value" :checked="currentValue === label" type="radio" name="colors"/>
...
export default {
    ...
    computed: {
        ...
        isAnimated() {
                return this.paret ? this.parent.animated || this.animated : this.animated;
        }
    },
    methods: {
        getfocus: function() {
